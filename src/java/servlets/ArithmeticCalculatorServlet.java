...
public class ArithmeticCalculatorServlet extends HttpServlet {
    ...
    protected void doPost (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(first == "" || second == "") {
            ...
            try {
                int parsedfirst = Integer.valueOf(first);
                int parsedsecond = Integer.valueOf(second);
                
                if(submit.equals("+")){
                result = String.valueOf((parsedfirst + parsedsecond));
        ...
        request.setAttribute("first_value", first);
        request.setAttribute("second_value", second);
